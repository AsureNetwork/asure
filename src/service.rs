...
use asure_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
use primitives::{ed25519, ed25519::Pair, Pair as PairT};
...
native_executor_instance!(
	pub Executor,
	asure_runtime::api::dispatch,
	asure_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/asure_runtime_wasm.compact.wasm")
);
